...
Subs::Vec3 Roche::drpot(double q, const Subs::Vec3& p){
    ...
    if(q <= 0.) throw Roche_Error("Roche::drpot(double, const Subs::Vec3&): q = " + to_string(q) + " <= 0.");
...
Subs::Vec3 Roche::drpot2(double q, double spin, const Subs::Vec3& p){
    ...
    if(q <= 0.) throw Roche_Error("Roche::drpot2(double, double, const Subs::Vec3&): q = " + to_string(q) + " <= 0.");
